            ...
            {dayOneCards.map((card) => (
              <article
                ...
                className={`relative flex flex-col overflow-hidden rounded-[28px] border border-[#dde1de] ${
                  card.variant === "center"
                    ? "order-2 z-20 w-full bg-[#fafafa] px-6 py-8 shadow-[0_0_30px_3px_rgba(41,108,51,0.15)] min-[501px]:max-[1023px]:col-start-1 min-[501px]:max-[1023px]:col-end-2 min-[501px]:max-[1023px]:translate-y-[48px] min-[501px]:max-[1023px]:min-h-[560px] min-[1024px]:w-[464px] min-[1024px]:min-h-[760px] min-[1024px]:px-[40px] min-[1024px]:py-[60px]"
                    : card.title === "JAM"
                      ? "order-3 z-10 mt-[-56px] w-[calc(100%-20px)] self-center bg-[#fafafa] px-6 pb-8 pt-[84px] min-[501px]:max-[1023px]:order-3 min-[501px]:max-[1023px]:mt-[15px] min-[501px]:max-[1023px]:w-[calc(100%-18px)] min-[501px]:max-[1023px]:self-center min-[501px]:max-[1023px]:px-6 min-[501px]:max-[1023px]:pb-8 min-[501px]:max-[1023px]:pt-8 min-[501px]:max-[1023px]:min-h-[530px] min-[1024px]:mt-[20px] min-[1024px]:w-[444px] min-[1024px]:min-h-[720px] min-[1024px]:self-start min-[1024px]:px-[50px] min-[1024px]:py-[40px]"
                ...
                className={`relative flex flex-col overflow-hidden rounded-[28px] border border-[#dde1de] ${
                  column.title === "Стоимость"
                    ...
                    : column.title === "Номинации"
                      ? "order-2 z-20 w-full bg-[#fafafa] px-6 py-8 shadow-[0_0_30px_3px_rgba(41,108,51,0.15)] min-[501px]:max-[1023px]:translate-y-[48px] min-[501px]:max-[1023px]:min-h-[560px] min-[1024px]:w-[464px] min-[1024px]:min-h-[760px] min-[1024px]:px-[40px] min-[1024px]:py-[60px]"
                      : "order-3 z-10 mt-[-56px] w-[calc(100%-20px)] self-center bg-[#fafafa] px-6 pb-8 pt-[84px] min-[501px]:max-[1023px]:mt-[15px] min-[501px]:max-[1023px]:w-[calc(100%-18px)] min-[501px]:max-[1023px]:self-center min-[501px]:max-[1023px]:px-6 min-[501px]:max-[1023px]:pb-8 min-[501px]:max-[1023px]:pt-8 min-[501px]:max-[1023px]:min-h-[530px] min-[1024px]:mt-[20px] min-[1024px]:w-[444px] min-[1024px]:min-h-[720px] min-[1024px]:px-[50px] min-[1024px]:py-[40px]"
                } ${
                  column.title === "Номинации"
                    ? "min-[1024px]:mx-[-24px]"
                    : column.title === "Стоимость"
